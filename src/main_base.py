...
from train_base import pretrain_gen, train_adv, train_dis, train_pri, train_gap
...
GEN_PATH = "../param/generator_v1" + args.v + ".pkl"
ADV_PATH = "../param/adversary_v1" + args.v + ".pkl"
DIS_PATH = "../param/discriminator_v1" + args.v + ".pkl"
